...
| cbor:<br> [cbor4ii 1.0.0][cbor4ii] | 654.58 µs | 5.1754 ms | 3.3341 ms | 1407835 | 403440 | 323561 | 5.0940 ms |
| cbor:<br> [ciborium 0.2.2][ciborium] | 4.1312 ms | 11.977 ms | † | 1407835 | 403440 | 323561 | 5.0136 ms |
| cbor:<br> [serde_cbor 0.11.2][serde_cbor] | 2.0901 ms | 4.9326 ms | 3.5093 ms | 1407835 | 403440 | 323561 | 4.7941 ms |
...
| json:<br> [serde_json 1.0.140][serde_json] | 3.6927 ms | 6.1232 ms | † | 1827461 | 470560 | 360727 | 5.5718 ms |
| json:<br> [simd-json 0.14.3][simd-json] | 2.0674 ms | 4.7367 ms | † | 1827461 | 470560 | 360727 | 5.5353 ms |
| messagepack:<br> [rmp-serde 1.3.0][rmp-serde] | 1.3618 ms | 3.0580 ms | 1.4100 ms | 784997 | 325384 | 277608 | 3.8072 ms |
...
| protobuf:<br> [prost 0.13.5][prost] | <span title="encode">*936.42 µs\**</span> <span title="populate + encode">*2.4790 ms\**</span> | 3.3301 ms | † | 884628 | 363130 | 314959 | 4.4483 ms |
| protobuf:<br> [protobuf 3.7.1][protobuf] | <span title="encode">*1.1788 ms\**</span> <span title="populate + encode">*2.9977 ms\**</span> | 3.7286 ms | † | 884628 | 363130 | 314959 | 4.4270 ms |
...
| scale:<br> [parity-scale-codec 3.7.4][parity-scale-codec] | 661.43 µs | 2.4183 ms | † | 765778 | 311743 | 263822 | 3.5065 ms |
...
| cbor:<br> [cbor4ii 1.0.0][cbor4ii] | 21.21% | 27.99% | 1.80% | 49.99% | 71.59% | 70.26% | 50.11% |
| cbor:<br> [ciborium 0.2.2][ciborium] | 3.36% | 12.09% | † | 49.99% | 71.59% | 70.26% | 50.91% |
| cbor:<br> [serde_cbor 0.11.2][serde_cbor] | 6.64% | 29.37% | 1.71% | 49.99% | 71.59% | 70.26% | 53.24% |
...
| json:<br> [serde_json 1.0.140][serde_json] | 3.76% | 23.66% | † | 38.51% | 61.38% | 63.02% | 45.81% |
| json:<br> [simd-json 0.14.3][simd-json] | 6.71% | 30.58% | † | 38.51% | 61.38% | 63.02% | 46.11% |
| messagepack:<br> [rmp-serde 1.3.0][rmp-serde] | 10.19% | 47.37% | 4.27% | 89.64% | 88.76% | 81.89% | 67.04% |
...
| protobuf:<br> [prost 0.13.5][prost] | <span title="encode">*14.82%\**</span> <span title="populate + encode">*5.60%\**</span> | 43.50% | † | 79.55% | 79.54% | 72.18% | 57.38% |
| protobuf:<br> [protobuf 3.7.1][protobuf] | <span title="encode">*11.78%\**</span> <span title="populate + encode">*4.63%\**</span> | 38.85% | † | 79.55% | 79.54% | 72.18% | 57.66% |
...
| scale:<br> [parity-scale-codec 3.7.4][parity-scale-codec] | 20.99% | 59.90% | † | 91.89% | 92.65% | 86.16% | 72.79% |
...
| cbor:<br> [cbor4ii 1.0.0][cbor4ii] | 10.002 ms | 48.803 ms | 13125016 | 7524114 | 6757437 | 90.728 ms |
| cbor:<br> [ciborium 0.2.2][ciborium] | 73.004 ms | 119.20 ms | 13122324 | 7524660 | 6759128 | 91.183 ms |
| cbor:<br> [serde_cbor 0.11.2][serde_cbor] | 35.873 ms | 46.724 ms | 13122324 | 7524660 | 6759128 | 91.112 ms |
...
| json:<br> [serde_json 1.0.140][serde_json] | 86.189 ms | 89.044 ms | 26192883 | 9566084 | 8584671 | 162.19 ms |
| json:<br> [simd-json 0.14.3][simd-json] | 51.528 ms | 76.187 ms | 26192883 | 9566084 | 8584671 | 156.41 ms |
| messagepack:<br> [rmp-serde 1.3.0][rmp-serde] | 15.705 ms | 16.055 ms | 8125006 | 6494876 | 6391037 | 70.229 ms |
...
| protobuf:<br> [prost 0.13.5][prost] | <span title="encode">*7.7971 ms\**</span> <span title="populate + encode">*8.5349 ms\**</span> | 12.458 ms | 8750000 | 6665735 | 6421877 | 72.549 ms |
| protobuf:<br> [protobuf 3.7.1][protobuf] | <span title="encode">*15.335 ms\**</span> <span title="populate + encode">*31.759 ms\**</span> | 30.214 ms | 8750000 | 6665735 | 6421877 | 80.486 ms |
...
| scale:<br> [parity-scale-codec 3.7.4][parity-scale-codec] | 5.0696 ms | 4.9713 ms | 6000004 | 5378496 | 5346866 | 8.6280 ms |
...
| cbor:<br> [cbor4ii 1.0.0][cbor4ii] | 1.49% | 0.31% | 45.71% | 68.88% | 72.84% | 9.39% |
| cbor:<br> [ciborium 0.2.2][ciborium] | 0.20% | 0.13% | 45.72% | 68.87% | 72.82% | 9.35% |
| cbor:<br> [serde_cbor 0.11.2][serde_cbor] | 0.41% | 0.32% | 45.72% | 68.87% | 72.82% | 9.36% |
...
| json:<br> [serde_json 1.0.140][serde_json] | 0.17% | 0.17% | 22.91% | 54.17% | 57.33% | 5.26% |
| json:<br> [simd-json 0.14.3][simd-json] | 0.29% | 0.20% | 22.91% | 54.17% | 57.33% | 5.45% |
| messagepack:<br> [rmp-serde 1.3.0][rmp-serde] | 0.95% | 0.94% | 73.85% | 79.79% | 77.01% | 12.14% |
...
| protobuf:<br> [prost 0.13.5][prost] | <span title="encode">*1.91%\**</span> <span title="populate + encode">*1.74%\**</span> | 1.21% | 68.57% | 77.75% | 76.64% | 11.75% |
| protobuf:<br> [protobuf 3.7.1][protobuf] | <span title="encode">*0.97%\**</span> <span title="populate + encode">*0.47%\**</span> | 0.50% | 68.57% | 77.75% | 76.64% | 10.59% |
...
| scale:<br> [parity-scale-codec 3.7.4][parity-scale-codec] | 2.94% | 3.03% | 100.00% | 96.35% | 92.05% | 98.79% |
...
| cbor:<br> [cbor4ii 1.0.0][cbor4ii] | 805.72 µs | 4.8259 ms | 3.5070 ms | 1109831 | 344745 | 274333 | 3.4498 ms |
| cbor:<br> [ciborium 0.2.2][ciborium] | 3.7415 ms | 10.229 ms | † | 1109821 | 344751 | 274345 | 3.3816 ms |
| cbor:<br> [serde_cbor 0.11.2][serde_cbor] | 1.8299 ms | 4.8945 ms | 3.5697 ms | 1109821 | 344751 | 274345 | 3.4508 ms |
...
| json:<br> [serde_json 1.0.140][serde_json] | 3.6697 ms | 6.7330 ms | † | 1623191 | 466527 | 359157 | 5.5941 ms |
| json:<br> [simd-json 0.14.3][simd-json] | 2.2045 ms | 4.6354 ms | † | 1623191 | 466527 | 359157 | 5.6356 ms |
| messagepack:<br> [rmp-serde 1.3.0][rmp-serde] | 1.5026 ms | 3.0503 ms | 1.7134 ms | 424533 | 245214 | 226077 | 2.2786 ms |
...
| protobuf:<br> [prost 0.13.5][prost] | <span title="encode">*1.2853 ms\**</span> <span title="populate + encode">*3.0051 ms\**</span> | 3.5207 ms | † | 596811 | 305319 | 268737 | 2.9749 ms |
| protobuf:<br> [protobuf 3.7.1][protobuf] | <span title="encode">*1.0476 ms\**</span> <span title="populate + encode">*3.0003 ms\**</span> | 3.7304 ms | † | 596811 | 305319 | 268737 | 3.0089 ms |
...
| scale:<br> [parity-scale-codec 3.7.4][parity-scale-codec] | 621.79 µs | 2.1071 ms | † | 356311 | 212976 | 198423 | 1.9282 ms |
...
| cbor:<br> [cbor4ii 1.0.0][cbor4ii] | 16.74% | 26.03% | 4.84% | 29.53% | 58.29% | 66.36% | 21.13% |
| cbor:<br> [ciborium 0.2.2][ciborium] | 3.61% | 12.28% | † | 29.53% | 58.29% | 66.35% | 21.56% |
| cbor:<br> [serde_cbor 0.11.2][serde_cbor] | 7.37% | 25.67% | 4.76% | 29.53% | 58.29% | 66.35% | 21.12% |
...
| json:<br> [serde_json 1.0.140][serde_json] | 3.68% | 18.66% | † | 20.19% | 43.07% | 50.69% | 13.03% |
| json:<br> [simd-json 0.14.3][simd-json] | 6.12% | 27.10% | † | 20.19% | 43.07% | 50.69% | 12.93% |
| messagepack:<br> [rmp-serde 1.3.0][rmp-serde] | 8.98% | 41.19% | 9.91% | 77.19% | 81.95% | 80.52% | 31.99% |
...
| protobuf:<br> [prost 0.13.5][prost] | <span title="encode">*10.50%\**</span> <span title="populate + encode">*4.49%\**</span> | 35.68% | † | 54.91% | 65.82% | 67.74% | 24.50% |
| protobuf:<br> [protobuf 3.7.1][protobuf] | <span title="encode">*12.88%\**</span> <span title="populate + encode">*4.50%\**</span> | 33.68% | † | 54.91% | 65.82% | 67.74% | 24.23% |
...
| scale:<br> [parity-scale-codec 3.7.4][parity-scale-codec] | 21.70% | 59.62% | † | 91.97% | 94.35% | 91.74% | 37.81% |
...
| cbor:<br> [cbor4ii 1.0.0][cbor4ii] | 3.0539 ms | 17.977 ms | 6012539 | 1695215 | 1464951 | 21.089 ms |
| cbor:<br> [ciborium 0.2.2][ciborium] | 23.729 ms | 56.399 ms | 6012373 | 1695146 | 1465025 | 21.759 ms |
| cbor:<br> [serde_cbor 0.11.2][serde_cbor] | 10.473 ms | 22.062 ms | 6012373 | 1695146 | 1465025 | 21.148 ms |
...
| json:<br> [serde_json 1.0.140][serde_json] | 20.468 ms | 30.970 ms | 9390461 | 2391679 | 1842767 | 35.007 ms |
| json:<br> [simd-json 0.14.3][simd-json] | 11.662 ms | 25.816 ms | 9390461 | 2391679 | 1842767 | 34.753 ms |
| messagepack:<br> [rmp-serde 1.3.0][rmp-serde] | 10.573 ms | 11.039 ms | 1745322 | 1261627 | 1228923 | 11.551 ms |
...
| protobuf:<br> [prost 0.13.5][prost] | <span title="encode">*5.4487 ms\**</span> <span title="populate + encode">*9.3563 ms\**</span> | 8.5889 ms | 1859886 | 1338076 | 1295351 | 12.063 ms |
| protobuf:<br> [protobuf 3.7.1][protobuf] | <span title="encode">*5.5339 ms\**</span> <span title="populate + encode">*12.717 ms\**</span> | 12.045 ms | 1859886 | 1338076 | 1295351 | 12.103 ms |
...
| scale:<br> [parity-scale-codec 3.7.4][parity-scale-codec] | 2.9551 ms | 3.3909 ms | 1319999 | 1064380 | 1010708 | 9.0060 ms |
...
| cbor:<br> [cbor4ii 1.0.0][cbor4ii] | 24.97% | 12.06% | 16.15% | 51.79% | 58.05% | 13.75% |
| cbor:<br> [ciborium 0.2.2][ciborium] | 3.21% | 3.84% | 16.16% | 51.80% | 58.04% | 13.33% |
| cbor:<br> [serde_cbor 0.11.2][serde_cbor] | 7.28% | 9.83% | 16.16% | 51.80% | 58.04% | 13.71% |
...
| json:<br> [serde_json 1.0.140][serde_json] | 3.73% | 7.00% | 10.34% | 36.71% | 46.14% | 8.29% |
| json:<br> [simd-json 0.14.3][simd-json] | 6.54% | 8.40% | 10.34% | 36.71% | 46.14% | 8.35% |
| messagepack:<br> [rmp-serde 1.3.0][rmp-serde] | 7.21% | 19.64% | 55.65% | 69.60% | 69.19% | 25.11% |
...
| protobuf:<br> [prost 0.13.5][prost] | <span title="encode">*14.00%\**</span> <span title="populate + encode">*8.15%\**</span> | 25.24% | 52.22% | 65.62% | 65.65% | 24.04% |
| protobuf:<br> [protobuf 3.7.1][protobuf] | <span title="encode">*13.78%\**</span> <span title="populate + encode">*6.00%\**</span> | 18.00% | 52.22% | 65.62% | 65.65% | 23.96% |
...
| scale:<br> [parity-scale-codec 3.7.4][parity-scale-codec] | 25.81% | 63.94% | 73.58% | 82.49% | 84.13% | 32.21% |
